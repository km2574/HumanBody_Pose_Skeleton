...
while cv2.waitKey(1) < 0:
    ...
    for i in range(nPoints):
        ...
        if prob > threshold : 
            ...
            cv2.putText(frameCopy, "{}".format(i), (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2, lineType=cv2.LINE_AA)
    ...
    for pair in POSE_PAIRS:
        ...
        if points[partA] and points[partB]:
            cv2.line(frame, points[partA], points[partB], (255, 255, 255), 3, lineType=cv2.LINE_AA)
